...
const CartScreen = () => {
  ...
  return (
    <SafeScreen>
      ...
      >
        <View className="px-6 gap-2 w-full">
          {cartItems.map((item, index) => (
            <View key={item._id} className="bg-surface rounded-3xl overflow-hidden w-full">
              <View className="p-4 flex-row">
                ...
                <View className="flex-1 ml-4 justify-between w-full">
                  <View>
                    <Text
      ...
      <View
       ...
       border-surface pt-4 pb-32 px-6 w-full"
      >
        {/* Quick Stats */}
