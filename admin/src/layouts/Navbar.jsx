...
import { ClipboardListIcon, HomeIcon, PanelLeftIcon, ShoppingCartIcon, UserIcon } from "lucide-react";
import { useLocation } from "react-router";

export const NAVIGATION = [
    {name:"Dashboard", path:"/dashboard", icon: <HomeIcon className="size-5"/>},
    {name:"Products", path:"/products", icon: <ShoppingCartIcon className="size-5"/>},
